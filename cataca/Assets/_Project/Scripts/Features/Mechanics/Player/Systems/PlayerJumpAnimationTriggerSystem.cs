...
{
    public class PlayerJumpAnimationTriggerSystem : IEcsInitSystem, IEcsPostRunSystem, IEcsGameSystem
    {
        public PlayerJumpAnimationTriggerSystem(PlayerAnimationConfig config)
        {
            _config = config;
        }
        ...
        public void PostRun(IEcsSystems systems)
        {
            foreach (var e in _filter)
            {
                ...
                animator.Animator.SetTrigger(_config.JumpTrigger);
            }
        }
    }
}