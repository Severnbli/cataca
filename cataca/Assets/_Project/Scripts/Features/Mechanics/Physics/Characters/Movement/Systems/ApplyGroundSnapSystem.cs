    ...
    public class ApplyGroundSnapSystem : IEcsInitSystem, IEcsPostRunSystem, IEcsGameSystem
    {
        ...
        public void PostRun(IEcsSystems systems)
        {
            foreach (var e in _filter)
            {
                ...
                if (groundCheckResult.GroundTransform == null) continue;
                
                ref var transform = ref _transformPool.Get(e);
                transform.Transform.localPosition += groundCheckResult.GroundTransform.position -
                                                     groundCheckResult.GroundLandingPosition;
            }
        }
    }
}